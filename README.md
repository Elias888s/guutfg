...
| -------------- | --------- | ----------  | --------------- | ----------- |
| ISP            | gi1/0/1   | DHCP        |                 |             |
|                | gi1/0/2   | 172.16.40.1  | 255.255.255.240 |             |
|                | gi1/0/3   | 172.16.50.1  | 255.255.255.240 |             |
| HQ-RTR         | ge0       | 172.16.40.2  | 255.255.255.240 | 172.16.40.1  |      
|                | ge1.15   | 192.168.0.1 | 255.255.255.224 |             |      
|                | ge1.25   | 192.168.0.33| 255.255.255.224 |             |      
|                | ge1.99   | 192.168.0.65| 255.255.255.240 |             |
|                | tunnel.1  | 172.16.1.1  | 255.255.255.252 |             |      
| BR-RTR         | ge0       | 172.16.50.2  | 255.255.255.240 | 172.16.50.1  |      
|                | te0       | 192.168.1.1 | 255.255.255.240 |             |
|                | tunnel.1  | 172.16.1.2  | 255.255.255.252 |             |
| HQ-SRV         | ens33     | 192.168.0.2 | 255.255.255.224 | 192.168.0.1 |      
| HQ-CLI         | ens192    | DHCP        | 255.255.255.224 | 192.168.0.33|      
| BR-SRV         | ens192    | 192.168.1.2 | 255.255.255.240 | 192.168.1.1 |
